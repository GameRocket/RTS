...
public class ScreenUtility : MonoBehaviour
{
    ...
    {
        //  Top
        ScreenUtility.DrawScreenRect(new Rect(rect.xMin, rect.yMin, rect.width, thickness), color);
        //  Left
        ScreenUtility.DrawScreenRect(new Rect(rect.xMin, rect.yMin, thickness, rect.height), color);
        //  Right
        ScreenUtility.DrawScreenRect(new Rect(rect.xMax - thickness, rect.yMin, thickness, rect.height), color);
        //  Bottom
        ScreenUtility.DrawScreenRect(new Rect(rect.xMin, rect.yMax - thickness, rect.width, thickness), color);
    }
